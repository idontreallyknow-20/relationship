...
export const CREATURES: CreatureDef[] = [
  ...
  otter(
    ...
    "#c9a68a", 6, 0.5,
    { cost: { currency: "shells", amount: 120 }, unlockLifetime: 50_000 },
  ),
  otter(
    ...
    "#8a6a52", 5.5, 2.4,
    { cost: { currency: "pearls", amount: 15 }, unlockLifetime: 2e6, needsDepth: 0.5 },
  ),
  otter(
    ...
    "#6a8a5a", 7, 2,
    {
      cost: { currency: "pearls", amount: 60 }, unlockLifetime: 5e7, needsDepth: 0.55,
  ...
  otter(
    ...
    "#7f7fa8", 5, 3.2,
    { cost: { currency: "pearls", amount: 220 }, unlockLifetime: 2e9, needsDepth: 0.6 },
  ),
  otter(
    ...
    "#5a4a3a", 6, 7,
    { cost: { currency: "stars", amount: 2 }, unlockLifetime: 1e13, needsDepth: 0.75 },
  ),
  otter(
    ...
    "#d0a84a", 4.5, 12,
    { cost: { currency: "stars", amount: 12 }, unlockLifetime: 1e17, needsDepth: 0.85 },
  ),
  ...
  crab(
    ...
    "#c07a4a", 9, 4,
    { cost: { currency: "pearls", amount: 15 }, unlockLifetime: 2e6 },
  ),
  crab(
    ...
    "#c0a880", 6, 2.2,
    {
      cost: { currency: "pearls", amount: 60 }, unlockLifetime: 5e7, needsFloor: 1.4,
      mods: { mul: { glassGain: 1.6, offline: 1.3 } },
    },
  ),
  crab(
    ...
    "#d8d0c0", 3, 3,
    { cost: { currency: "pearls", amount: 220 }, unlockLifetime: 2e9, needsFloor: 1.8 },
  ),
  crab(
    ...
    "#7a5a3a", 7, 6,
    { cost: { currency: "stars", amount: 2 }, unlockLifetime: 1e13, needsFloor: 3 },
  ),
  crab(
    ...
    "#4a6ac0", 5, 11,
    { cost: { currency: "stars", amount: 12 }, unlockLifetime: 1e17, needsFloor: 4 },
  ),
];
...
export const TRAITS: TraitDef[] = [
  { id: "eager", name: "Eager", line: "any", description: "Acts more often.", mods: { mul: { crackSpeed: 1.15, collectSpeed: 1.15 } }, weight: 100 },
  { id: "strong", name: "Strong", line: "any", description: "Each action is worth more.", mods: { mul: { crackValue: 1.2, collectValue: 1.2 } }, weight: 100 },
  { id: "sleepy", name: "Sleepy", line: "any", description: "Far better while you are away.", mods: { mul: { offline: 1.3 } }, weight: 70 },
  { id: "lucky", name: "Lucky", line: "any", description: "Finds pearls it had no right to find.", mods: { mul: { pearlGain: 1.35 } }, weight: 45 },
  { id: "tidy", name: "Tidy", line: "crab", description: "Collects more sea glass.", mods: { mul: { glassGain: 1.4 } }, weight: 60 },
  { id: "playful", name: "Playful", line: "otter", description: "Raises the whole raft.", mods: { mul: { crackValue: 1.15, all: 1.04 } }, weight: 60 },
  { id: "patient", name: "Patient", line: "crab", description: "Slower, but much heavier.", mods: { mul: { collectValue: 1.5, collectSpeed: 0.8 } }, weight: 50 },
