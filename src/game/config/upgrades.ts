...
// Three sets. Cami's is her otters and the tapping, Joseph's is his crabs and
// what the jar does without you, and Us is shared.
//
// The copy in here describes the game as it is. It used to describe otters
// cracking shells open, pieces sinking to a floor, and crabs walking along it
// picking them up, none of which has happened since the jar became a jar you
// tap hearts into. An upgrade that describes a mechanic the game does not have
// is worse than one with no description at all.
...
const CAMI = tree("cami", { kind: "add", stat: "clickFlat" }, [
  ...
  { after: "otter_hands", id: "quick_paws", name: "Quick Paws", description: "Your otters make the trip more often.", cost: 200, growth: 1.3, per: 0.05, kind: "mulLinear", stat: "petSpeed", max: 40 },
  { after: "quick_paws", id: "shell_cracking", name: "Sure Footing", description: "Every trip they make carries more.", cost: 400, growth: 1.28, per: 0.09, kind: "mulLinear", stat: "petValue", max: 60 },
  ...
  { after: "shell_cracking", id: "floating_together", name: "Floating Together", description: "Otters sitting next to each other carry more.", cost: 40_000, growth: 1.4, per: 0.12, kind: "mulLinear", stat: "pairBonus", max: 30, unlock: { lifetimeHearts: 30_000 } },
  ...
  { after: "floating_together", id: "cracking_stone", name: "Careful Hands", description: "Sealing a jar pays more ribbons.", cost: 400_000, growth: 1.4, per: 0.14, kind: "mulLinear", stat: "ribbonGain", max: 40 },
  { after: "cracking_stone", id: "pup_patrol", name: "Pup Patrol", description: "Every pet at the table works harder.", cost: 1.2e6, growth: 1.42, per: 0.11, kind: "mulLinear", stat: "creaturePower", max: 40, unlock: { lifetimeHearts: 1e6 } },
  ...
  { after: "cracking_stone", id: "pearl_diver", name: "Ribbon Winder", description: "Sealing pays far more ribbons.", cost: 2e7, growth: 1.5, per: 0.13, kind: "mulLinear", stat: "ribbonGain", max: 40, unlock: { lifetimeHearts: 1.5e7 } },
  { after: "pup_patrol", id: "her_favourite_rock", name: "Her Favourite Rock", description: "Whatever a pet is carrying counts for more.", cost: 8e7, growth: 1.52, per: 0.15, kind: "mulLinear", stat: "creaturePower", max: 30, unlock: { lifetimeHearts: 6e7 } },
  ...
  { after: "moonlit_water", id: "holding_on", name: "Holding On", description: "A broken combo drops by half instead of to nothing.", cost: 2e9, growth: 1.8, per: 1, stat: "comboShield", max: 8, unlock: { tideChanges: 1 } },
  ...
  { after: "her_favourite_rock", id: "raft", name: "Raft", description: "The otters work as one and carry far more.", cost: 8e11, growth: 1.7, per: 0.25, kind: "mulLinear", stat: "petValue", max: 30, unlock: { tideChanges: 2 } },
  ...
  { after: "otter_hands", id: "steady_drip", name: "Steady Drip", description: "The jar fills a little on its own.", cost: 120, growth: 1.16, per: 0.5, stat: "cpsFlat" },
  ...
  { after: "night_owl", id: "left_running", name: "Left Running", description: "Every hour away is worth more.", cost: 30_000, growth: 1.38, per: 0.1, kind: "mulLinear", stat: "offline", max: 40 },
  { after: "quick_paws", id: "sea_spray", name: "Good Fortune", description: "Better things turn up when a pet goes out.", cost: 3_000, growth: 1.34, per: 0.0015, stat: "luck", max: 40 },
  { after: "shell_cracking", id: "slippery_rock", name: "Slippery Rock", description: "The otters are quicker on their feet.", cost: 5_000, growth: 1.3, per: 0.06, kind: "mulLinear", stat: "petSpeed", max: 40 },
  { after: ["playful", "quick_paws"], id: "lucky_dive", name: "Lucky Dive", description: "Luckier trips, all round.", cost: 25_000, growth: 1.38, per: 0.03, stat: "luck", max: 30 },
...
const JOSEPH = tree("joseph", { kind: "add", stat: "cpsFlat" }, [
  { id: "sideways_walk", name: "Sideways Walk", description: "The jar fills a little on its own.", cost: 60, growth: 1.15, per: 0.6 },
  { after: "sideways_walk", id: "pincer_strength", name: "Pincer Strength", description: "Every trip his crabs make carries more.", cost: 350, growth: 1.28, per: 0.09, kind: "mulLinear", stat: "petValue", max: 60 },
  { after: "pincer_strength", id: "tidepool_sweep", name: "Quick Crossing", description: "The crabs cross the table faster.", cost: 700, growth: 1.3, per: 0.05, kind: "mulLinear", stat: "petSpeed", max: 40 },
  { after: "sideways_walk", id: "shell_collecting", name: "Full Claws", description: "Sealing a jar pays more ribbons.", cost: 2_000, growth: 1.32, per: 0.13, kind: "mulLinear", stat: "ribbonGain", max: 40 },
  { after: "sideways_walk", id: "hard_shell", name: "Hard Shell", description: "A broken combo drops by half instead of to nothing.", cost: 9_000, growth: 1.9, per: 1, stat: "comboShield", max: 8 },
  ...
  { after: "shell_collecting", id: "sand_sifting", name: "Neat Knots", description: "Sealing pays more ribbons again.", cost: 55_000, growth: 1.36, per: 0.14, kind: "mulLinear", stat: "ribbonGain", max: 40 },
  { after: "hard_shell", id: "his_deep_pocket", name: "His Deep Pocket", description: "The jar holds far more before it counts as full.", cost: 120_000, growth: 1.3, per: 40_000, stat: "capacity", max: 60, unlock: { lifetimeHearts: 80_000 } },
  { after: "his_deep_pocket", id: "burrow_deeper", name: "Burrow Deeper", description: "More hours away are counted.", cost: 300_000, growth: 1.45, per: 1, stat: "offlineHours", max: 40, unlock: { lifetimeHearts: 250_000 } },
  { after: "burrow_deeper", id: "patience", name: "Patience", description: "Every hour away is worth more.", cost: 700_000, growth: 1.42, per: 0.1, kind: "mulLinear", stat: "offline", max: 40 },
  ...
  { after: "sand_sifting", id: "night_scuttle", name: "Night Scuttle", description: "The pets keep going while you are away.", cost: 9e6, growth: 1.45, per: 0.12, kind: "mulLinear", stat: "creaturePower", max: 40, unlock: { lifetimeHearts: 7e6 } },
  { after: "steady_hands", id: "hoarding", name: "Hoarding", description: "Everything the jar makes without you, multiplied.", cost: 4e7, growth: 1.5, per: 0.2, kind: "mulLinear", stat: "cps", max: 30, unlock: { lifetimeHearts: 3e7 } },
  { after: "claw_sharpening", id: "low_tide_reach", name: "Never Still", description: "The crabs never stop moving.", cost: 1.5e8, growth: 1.5, per: 0.12, kind: "mulLinear", stat: "petSpeed", max: 30, unlock: { lifetimeHearts: 1e8 } },
  { after: "night_scuttle", id: "his_shell", name: "The One That Fits", description: "Whatever a crab is wearing counts for more.", cost: 6e8, growth: 1.52, per: 0.15, kind: "mulLinear", stat: "creaturePower", max: 30, unlock: { lifetimeHearts: 5e8 } },
  { after: "his_shell", id: "molt_faster", name: "Molt Faster", description: "The pets learn much faster.", cost: 3e9, growth: 1.55, per: 0.25, kind: "mulLinear", stat: "creatureXp", max: 30, unlock: { tideChanges: 1 } },
  { after: "low_tide_reach", id: "ghost_step", name: "Ghost Step", description: "Every pet moves far quicker.", cost: 2e10, growth: 1.6, per: 0.18, kind: "mulLinear", stat: "petSpeed", max: 25, unlock: { tideChanges: 1 } },
  ...
  { after: "early_riser", id: "slept_in", name: "Slept In", description: "Every hour away is worth more.", cost: 25_000, growth: 1.37, per: 0.11, kind: "mulLinear", stat: "offline", max: 40 },
  { after: "pincer_strength", id: "slow_current", name: "Slow Current", description: "Nothing a crab carries is ever dropped.", cost: 4_000, growth: 1.29, per: 0.08, kind: "mulLinear", stat: "petValue", max: 50 },
  { after: ["shell_collecting", "tidepool_sweep"], id: "driftwood", name: "Worth The Trip", description: "Every trip a pet makes is worth far more.", cost: 30_000, growth: 1.4, per: 0.18, kind: "mulLinear", stat: "petValue", max: 30 },
  ...
  { after: ["sand_sifting", "claw_sharpening"], id: "tide_pools", name: "Tidy Shelf", description: "Sealing pays more, and pays it sooner.", cost: 8e6, growth: 1.46, per: 0.16, kind: "mulLinear", stat: "ribbonGain", max: 40, unlock: { lifetimeHearts: 6e6 } },
...
const US = tree("us", { kind: "mulLinear", stat: "all", currency: "keepsakes" }, [
  ...
  { after: "holding_hands", id: "same_tide", name: "Same Evening", description: "Keepsakes arrive faster, whoever is playing.", cost: 8, growth: 1.35, per: 0.1, stat: "keepsakeGain", max: 30 },
  { after: "holding_hands", id: "two_currents", name: "Two Currents", description: "Every pet at the table works harder.", cost: 12, growth: 1.4, per: 0.09, stat: "creaturePower", max: 30 },
  ...
  { after: "same_tide", id: "warm_evening", name: "Long Evening", description: "Keepsakes arrive faster still.", cost: 70, growth: 1.5, per: 0.12, stat: "keepsakeGain", max: 25 },
