...
export const AFFIXES: AffixDef[] = [
  { id: "crack_value", label: "Crack payout", kind: "mul", stat: "petValue", base: 0.12, weight: 100, only: "rock" },
  { id: "crack_speed", label: "Crack speed", kind: "mul", stat: "petSpeed", base: 0.08, weight: 80, only: "rock" },
